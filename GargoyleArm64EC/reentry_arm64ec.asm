...
; Called from setup_arm64ec as void wait_entry(ArmConfiguration*).
; This remains executable while setup_arm64ec.pic is parked PAGE_READONLY.
wait_body
        stp     x19, x30, [sp, #-16]!
        mov     x19, x0
        ...
        ; Returning to setup_arm64ec.pic is safe only after execute permission is restored.
